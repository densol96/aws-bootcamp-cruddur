...
create_message_group(
  ...
  other_user_handle=users['other_user']['nickname'],
  other_user_display_name=users['other_user']['name'],
...
create_message_group(
  ...
  other_user_handle=users['my_user']['nickname'],
  other_user_display_name=users['my_user']['name'],
  last_message_at=now.isoformat(),
  message="this is a filler message"
)
